...
import com.e.trackeractivity.Adapter.MahasiswaCRUDRecyclerAdapter;
...
public class MahasiswaGetAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Mahasiswa>> call = service.getMahasiswa("72170158");
        ...
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                pd.dismiss();
                Toast.makeText(MahasiswaGetAllActivity.this, "Eror", Toast.LENGTH_LONG).show();
            }
        });
    }
}
